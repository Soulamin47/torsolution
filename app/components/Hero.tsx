...
export default function Hero() {
  ...
  const badge =
    lang === "en" ? "Advanced Product Engineer" : "Ingénieur Produit Avancé";

  return (
    <section className="relative overflow-hidden px-8 pt-32 pb-20">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-gray-200"
        >
          {badge}
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-4 text-xs uppercase tracking-[0.25em] text-gray-400"
        >
          Web · AI · Cloud · Web3
        </motion.p>
